    ...
    Tables: {
      ...
      "products": {
        Row: {
          ...
          "tiendanube_free_shipping": boolean | null;
          "tiendanube_requires_shipping": boolean | null;
          "tiendanube_has_stock": boolean | null;
          "tiendanube_price_min": number | null;
          "tiendanube_price_max": number | null;
          "tiendanube_promotional_price_min": number | null;
          "tiendanube_description": string | null;
          "tiendanube_seo_title": string | null;
          "tiendanube_seo_description": string | null;
          "tiendanube_tags": string | null;
          "tiendanube_canonical_url": string | null;
          "tiendanube_video_url": string | null;
          "tiendanube_image_urls": string[] | null;
          "tiendanube_attributes_json": Json | null;
          "tiendanube_categories_json": Json | null;
